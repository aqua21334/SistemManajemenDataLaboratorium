...
<div class="sidebar shadow">
    <div class="text-center mb-4 px-3" style="padding-right: 15px;">
        ...
        <li class="nav-item"><a href="{{ route('kepala.sop') }}" class="nav-link active"><i class="bi bi-file-earmark-check-fill me-2"></i> SOP</a></li>
...
<div class="main-wrapper">
    ...
    <div class="dashboard-container">
        ...
        <div class="toolbar-card">
            <div class="toolbar-title">Data SOP</div>
            <form method="GET" action="{{ route('kepala.sop') }}" class="d-flex justify-content-between align-items-center mt-2">
                ...
                <div class="search-wrapper">
                    ...
                    <input type="text" name="search" class="search-input" placeholder="Cari SOP..." value="{{ $search ?? '' }}" onkeypress="if(event.key === 'Enter') this.form.submit();">
                </div>
            </form>
        </div>
        ...
        <div class="table-card shadow-sm">
            <table class="table-custom">
                ...
                <tbody>
                    ...
                    @empty
                    <tr>
                        <td colspan="5" class="text-center text-muted py-4">Tidak ada data SOP</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
