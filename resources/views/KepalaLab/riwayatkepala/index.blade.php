...
<head>
    ...
    <title>Data Riwayat Laporan - Lab Rawa</title>
    <!-- Bootstrap 5 CSS -->
...
<div class="sidebar shadow">
    <div class="text-center mb-4 px-3" style="padding-right: 15px;">
        ...
        <li class="nav-item"><a href="{{ route('kepala.riwayat') }}" class="nav-link active"><i class="bi bi-file-earmark-bar-graph-fill me-2"></i> Riwayat Penelitian</a></li>
    </ul>
...
<div class="main-wrapper">
    ...
    <div class="dashboard-container">
        ...
        <div class="toolbar-card">
            <div class="toolbar-title">Data Riwayat Laporan</div>
            <form method="GET" action="{{ route('kepala.riwayat') }}" class="mt-2 d-flex justify-content-between align-items-center">
                <!-- Search Box -->
                <div class="search-wrapper">
                    <div class="search-icon-box">
                        <i class="bi bi-search"></i>
                    </div>
                    <input type="text" name="search" class="search-input" placeholder="Cari riwayat penelitian..." value="{{ $search ?? '' }}" onkeypress="if(event.key === 'Enter') this.form.submit();">
                </div>
        </div>
