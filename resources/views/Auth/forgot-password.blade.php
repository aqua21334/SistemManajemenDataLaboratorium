...
<head>
    ...
    <title>Lupa Password - Balai Teknik Rawa</title>
    ...
    <div class="auth-card">
        <div class="form-side">
            ...
            <div style="margin-top: 60px;">
                <h3>Lupa Password</h3>
                <p class="sub-text">Masukkan email customer untuk menerima link reset password</p>
        ...
        <div class="panel-side">
            <h3 class="text-white mb-3">Atur Ulang Password</h3>
            <p style="font-family: sans-serif; font-size: 13px; margin-bottom: 0; color: #e2e8f0;">
                Link reset akan dikirim ke email customer yang terdaftar.
            </p>
        </div>
    </div>
</body>
