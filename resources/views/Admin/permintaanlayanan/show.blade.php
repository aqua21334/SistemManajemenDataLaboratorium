...
<div class="main-wrapper">
    ...
    <div class="dashboard-container shadow-sm">
        <div class="form-container">
            ...
            <form action="{{ route('permintaan.update', $permintaan->id_permintaan) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row g-5">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="d-flex justify-content-end gap-3 mt-5">
                            <a href="{{ route('permintaan.index') }}" class="btn-form btn-kembali">Kembali</a>
