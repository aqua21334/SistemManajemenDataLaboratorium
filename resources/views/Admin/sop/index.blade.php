        ...
        <table class="table-sop">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @if($sop->file_sop)
                            <a href="{{ asset('uploads/sop/'.$sop->file_sop) }}" target="_blank" class="text-decoration-none text-success fw-bold">
                                <i class="bi bi-file-earmark-pdf-fill me-1"></i> Terlampir
                            </a>
                        @else
                    ...
                    <td>
                        <div class="d-flex justify-content-center gap-2">
                            <a href="{{ route('sop.edit', $sop->id_sop) }}" class="btn-action-edit">Edit</a>
                            <form action="{{ route('sop.destroy', $sop->id_sop) }}" method="POST" class="d-inline">
                                @csrf @method('DELETE')
                                <button type="submit" class="btn-action-hapus" onclick="return confirm('Hapus dokumen ini?')">Hapus</button>
                            </form>
                        </div>
                    </td>
                </tr>
